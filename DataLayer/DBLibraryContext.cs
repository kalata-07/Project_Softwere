...
namespace DataLayer
{
    public partial class DBLibraryContext : IdentityDbContext<User>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                throw new Exception("Create empty MVC and add the connection file to appsettings.json and configure Program.cs to use it! Then Update-Database the migration!");
            }
        }
